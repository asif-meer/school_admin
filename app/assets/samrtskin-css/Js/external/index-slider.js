...
$(document).ready(function () {
    function d() {
        ...
        setTimeout(function () {
            $(".slide.active img.fade,.slide.active .info").fadeIn(2000, "easeInOutQuad", function () {
                $("#feature_slider").removeClass()
            })
            $(".slide.active img.fade,.slide.active .info1").fadeIn(2000, "easeInOutQuad", function () {
                    $("#feature_slider").removeClass()
                })
        }, 2000)
    }
    function c() {
        ...
        function g() {
            ...
            $(".slide.previous img.fade,.slide.previous .info1").fadeOut(600, "easeInQuad", function () {
                $(".slide.next").removeClass("next").addClass("active").fadeIn(2000, "easeInOutQuad", function () {
                    $(".slide.previous").removeClass("previous").fadeOut(600, "easeInOutQuad");
                    j()
                })
            })
